        ...
        static void Main(string[] args)
        {
            ...
            while (isRunning)
            {
                ...
                switch (userInput)
                {
                    ...
                    case "2":
                        Console.Clear();
                        Console.WriteLine("Enter the name of the user you want to check if available.");
                        Console.WriteLine("The program will also check for duplicate users!");
                        string userNameToCheck = Console.ReadLine();
